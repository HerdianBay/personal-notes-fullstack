...
export default function AuthHeader() {
  ...
  return (
    <header
      className={
        darkMode
          ? "flex justify-between w-full items-center p-4 border-b border-white"
          : "flex justify-between w-full items-center p-4 border-b border-black"
      }
    >
      <h1 className="max-w-1/2">
        <Link
          to={"/"}
          className="text-[32px] font-bold underline leading-[125%]"
        >
